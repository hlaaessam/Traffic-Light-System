...
export class OneComponent implements OnInit {
  ...
  mySentences:Array<string> = [
    "width: 50px; height: 50px; border-radius: 50%; background-color: red ; margin-left: 150px;margin-bottom: 20px;",
    "width: 50px; height: 50px; border-radius: 50%; background-color: yellow ; margin-left: 150px;margin-bottom: 20px;",
   "width: 50px; height: 50px; border-radius: 50%; background-color: green ; margin-left: 150px;margin-bottom: 20px;"
];
number=0;
